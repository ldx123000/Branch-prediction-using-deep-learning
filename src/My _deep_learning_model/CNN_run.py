...
def run_on(branches):
  ...
  for branch in branches:
    ...
    try:
      ...
      torch.save(src_dict, "My CNN.pt")
      for i in src_dict.keys():
          print(str(i)+'  '+str(src_dict[i].size()))
...
TARGET_BENCHMARKS = os.path.dirname(os.path.abspath(__file__)) + '/../../dataset'
TRAIN_FILE = TARGET_BENCHMARKS+'/training'
EVAL_FILE = TARGET_BENCHMARKS+'/training'
OUTPUT_FILE = os.path.dirname(os.path.abspath(__file__)) + '/../../result_CNN'
